...
int main(int argc, char** argv) {
    ...
    cudaMalloc((void **) &device_src, height * width * channels * sizeof(unsigned char));
    cudaMalloc((void **) &device_dst, height * width * channels * sizeof(unsigned char));
    ...
    dim3 block(16, 16, 1);
    sobel <<<grid, block>>> (device_src, device_dst, height, width, channels);
